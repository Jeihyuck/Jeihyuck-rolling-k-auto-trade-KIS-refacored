...
def test_preflight_only_wrappers_ignore_stale_paths_and_log_metadata(tmp_path):
 for script,(market,session) in WRAPPERS.items():
  env={**os.environ,'NULLIM_APP_DIR':'/old/path','NULLIM_RESOLVED_REPO_ROOT':'/another/old/path','NULLIM_PREFLIGHT_ONLY':'1','ALLOW_STALE_CODE':'1','ALLOW_DIRTY_CODE':'1','NULLIM_TRADING_DAY_OVERRIDE':'open','NULLIM_PYTHON_BIN':os.sys.executable,'NULLIM_EPOCH_PREFLIGHT_SKIP':'1'}
