...
function New-NullimTaskActionArguments([string]$Distro, [string]$Repo, [string]$Script, [string[]]$Args) {
  ...
  $linuxCommand="unset NULLIM_APP_DIR; cd $repoQ && exec bash $scriptQ"
...
$canonical=@($defs|ForEach-Object Name);$repoMarker='Jeihyuck-rolling-k-auto-trade-KIS-refacored';$runnerMarker='run-kr-|run-us-|run_pb1_kr\.sh|send-market-log-mail\.sh|check-nullim-day-health\.sh|pb1_runner|trade_session_runner'
