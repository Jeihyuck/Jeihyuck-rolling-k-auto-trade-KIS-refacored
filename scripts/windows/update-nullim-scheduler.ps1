...
$defs = @(
  ...
  @{Name="PB1 US Prep Recovery WSL"; Time="22:10"; Cmd="bash $base/run-us-prep-recovery.sh"; Limit="PT45M"},
  @{Name="PB1 US AM Preflight WSL"; Time="22:20"; Cmd="bash $base/check-us-prep-before-am.sh"; Limit="PT15M"},
