...
$expected = [ordered]@{
 ...
 "PB1 US Prep Prewarm EDT WSL"=@("19:30","run-us-prep.sh"); "PB1 US Prep Prewarm EST WSL"=@("20:30","run-us-prep.sh"); "PB1 US Prep WSL"=@("21:30","run-us-prep.sh"); "PB1 US Prep Recovery WSL"=@("22:10","bash $Repo/scripts/wsl/run-us-prep-recovery.sh"); "PB1 US AM Preflight WSL"=@("22:20","bash $Repo/scripts/wsl/check-us-prep-before-am.sh"); "PB1 US AM WSL"=@("22:30","run-us-am.sh"); "PB1 US Afternoon WSL"=@("02:00","run-us-afternoon.sh"); "PB1 US Close WSL"=@("05:05","run-us-close.sh"); "PB1 US Mail WSL"=@("07:00","send-market-log-mail.sh us"); "PB1 US Health WSL"=@("07:10","check-nullim-day-health.sh us")
}
$failed=$false
