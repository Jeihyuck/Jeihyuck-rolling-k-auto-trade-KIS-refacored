...
ALLOWED_PROVIDER_CHAIN = {
    "practice": ["fdr_kospi100_kosdaq100", "fdr_marketcap_top", "lkg", "sqlite_cache", "seed_static"],
    "real": ["fdr_kospi100_kosdaq100", "fdr_marketcap_top", "kis_marketcap_top", "lkg", "sqlite_cache", "seed_static"],
}
