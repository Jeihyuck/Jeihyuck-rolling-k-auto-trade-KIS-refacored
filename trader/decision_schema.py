...
EXIT_DECISION_FAMILIES = {"EXIT_STOP", "EXIT_TRAIL", "EXIT_TIME", "EXIT_MA_BREAK", "EXIT_RISK_OFF", "EXIT_MANUAL", "SKIP"}
...
def normalize_exit_decision(reason: Any) -> tuple[str, str]:
    ...
    mapping = {
        "EXIT_HARD_STOP": ("EXIT_STOP", "EXIT_HARD_STOP"),
        "EXIT_TRAIL": ("EXIT_TRAIL", "EXIT_TRAIL"),
        "EXIT_SOFT_RISK_OFF": ("EXIT_RISK_OFF", "EXIT_SOFT_RISK_OFF"),
        "EXIT_TIME_BASED": ("EXIT_TIME", "EXIT_TIME_BASED"),
        "EXIT_MANUAL": ("EXIT_MANUAL", "EXIT_MANUAL"),
