...
""",
    ...
    bindparams = [
        ...
        sa.bindparam("avg_cost_at_sell", value=None, type_=sa.Numeric()),
        sa.bindparam("realized_pnl_usd", value=None, type_=sa.Numeric()),
        sa.bindparam("realized_pnl_pct", value=None, type_=sa.Numeric()),
