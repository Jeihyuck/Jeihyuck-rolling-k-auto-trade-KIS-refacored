...
def _apply_regime_session_summary(report: dict, session_summary: dict | None) -> dict:
    ...
    for key in (
        ...
        "session_buy_notional_routed", "session_fills_confirmed_notional",
        "daily_cumulative_orders_sent", "daily_cumulative_orders_ack",
        "daily_orders_sent_total", "daily_orders_ack_total", "daily_fills_confirmed_total",
        "daily_buy_notional_filled", "daily_sell_notional_filled", "daily_net_notional_filled",
        "daily_order_audit_buy_notional", "daily_order_audit_sell_notional",
        "entry_candidate_notional_evaluated", "entry_intent_notional_before_risk",
        "entry_intent_notional_after_risk", "orders_submitted_notional",
        "orders_acknowledged_notional", "fills_confirmed_notional",
        "order_audit_buy_notional", "order_audit_sell_notional",
        "close_session_orders_sent", "close_session_buy_notional_routed",
        "no_new_orders_reason", "daily_buy_limit_usd", "daily_buy_notional_filled_usd",
        "daily_buy_budget_remaining_usd", "daily_notional_exceeded_block_count",
        "daily_notional_exceeded_block_symbols", "largest_blocked_candidates",
        "kis_temp_error_raw_log_count", "kis_temp_error_sequence_count",
        "kis_temp_error_recovered_sequence_count", "kis_temp_error_unrecovered_sequence_count",
        "kis_temp_error_by_endpoint", "kis_temp_error_by_session",
        "kis_temp_error_order_endpoint_count", "kis_temp_error_price_endpoint_count",
...
def run_daily_report(
    ...
    report: dict = {
        **_report_provenance(session),
        ...
        "session_fills_confirmed_notional": 0.0,
        "daily_cumulative_buy_notional_filled": 0.0,
        "daily_orders_sent_total": 0,
        "daily_orders_ack_total": 0,
        "daily_fills_confirmed_total": 0,
        "daily_buy_notional_filled": 0.0,
        "daily_sell_notional_filled": 0.0,
        "daily_net_notional_filled": 0.0,
        "daily_order_audit_buy_notional": 0.0,
        "daily_order_audit_sell_notional": 0.0,
        ...
        "order_audit_buy_notional": 0.0,
        "order_audit_sell_notional": 0.0,
        "close_session_orders_sent": 0,
        "close_session_buy_notional_routed": 0.0,
        ...
        "kis_temp_error_by_session": {},
        "kis_temp_error_order_endpoint_count": 0,
        "kis_temp_error_price_endpoint_count": 0,
        "kis_temp_error_balance_endpoint_count": 0,
        "kis_temp_error_fill_endpoint_count": 0,
