...
def build_us_prep_contract(
    *,
    ...
    contract = {
        ...
        "prep_structural_entry_ok": int(entry_can_proceed == 1 and trade_block_reason == "ok"),
        "runtime_market_state_required": True,
        "entry_can_proceed_initial": entry_can_proceed,
        "previous_close_market_state": market_state.get("previous_close_market_state", market_state.get("market_state")),
        "previous_close_market_regime": market_state.get("previous_close_market_regime", market_state.get("market_regime")),
        "previous_close_risk_seed": market_state.get("previous_close_market_state", market_state.get("market_state")),
