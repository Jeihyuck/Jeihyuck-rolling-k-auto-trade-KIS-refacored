...
FORCE_MIN1_OVERRIDE_POSITION_CAP = _cfg_bool("FORCE_MIN1_OVERRIDE_POSITION_CAP", fallback=False)
FORCE_MIN1_OVERRIDE_TOPN = int(_cfg("FORCE_MIN1_OVERRIDE_TOPN") or "2")
